...
return new class extends Migration
{
     ...
     * create_sales_table migration before 'car_deposit' was added to its
    ...
    public function up(): void
    {
        if (DB::connection()->getDriverName() === 'mysql') {
            DB::statement("ALTER TABLE sales MODIFY source ENUM('pos', 'wine_reservation', 'competition_entry', 'website_order', 'car_deposit') NOT NULL DEFAULT 'pos'");
        }
    }
